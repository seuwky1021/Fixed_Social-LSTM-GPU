...
def main():
    ...
    for iteration in range(sample_args.iteration):
        ...
        for batch in range(dataloader.num_batches):
            ...
            # 这个地方把get_final_error修改了，添加了use_cuda参数，和get_mean_error一样
            ...
            final_error += get_final_error(ret_x_seq[1:sample_args.obs_length].data, orig_x_seq[1:sample_args.obs_length].data, PedsList_seq[1:sample_args.obs_length], PedsList_seq[1:sample_args.obs_length],sample_args.use_cuda, lookup_seq)
            ...
            # print(dataloader.is_cuda)
            # print(ret_x_seq.is_cuda)
            # print(sample_args.pred_length.is_cuda)
            # print(sample_args.obs_length.is_cuda)
            # print(target_id.is_cuda)

            # 这里ret_x_seq.data后面要加.cpu()，因为gpu不能用numpy，要先转cpu()
...
def submission_preprocess(dataloader, ret_x_seq, pred_length, obs_length, target_id):
    # print(dataloader.is_cuda)
    # print(ret_x_seq.is_cuda)
    # print(pred_length.is_cuda)
    # print(obs_length.is_cuda)
    # print(target_id.is_cuda)
